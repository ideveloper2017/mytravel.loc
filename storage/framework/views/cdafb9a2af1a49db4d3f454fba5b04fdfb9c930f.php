    ...
    <form action="<?php echo e(route('page.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
        ...
        <div class="container">
            <div class="d-flex justify-content-between mb20">
                ...
                <div class="">
                    <?php if($row->id): ?>
                        <a class="btn btn-primary btn-sm" href="<?php echo e(route('page.admin.builder',['id'=>$row->id,'lang'=>request()->query('lang')])); ?>"><i class="fa fa-paint-brush"></i> <?php echo e(__('Template Builder')); ?></a>
                    <?php endif; ?>
                    <?php if($row->slug): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/DATAHDD/www/mytravel.loc/modules/Page/Views/admin/detail.blade.php ENDPATH**/ ?>